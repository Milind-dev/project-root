...
/* export const empOnBoardingDelete = async (req, res) => {
  try {
    const { id } = req.params;
    ...
    const deleted = await onboardingModel.findByIdAndDelete(id);
    ...
    console.error("empOnBoardingDelete error:", err);
...
// export const empOnBoardingDelete = async (req,res) => {
//   const {id} = req.query
//   const data = onboardingModel.findById({id})
// }
